        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration_in_Hrs = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Modified_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ImagePathUpload = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImagePathTimesheet = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
